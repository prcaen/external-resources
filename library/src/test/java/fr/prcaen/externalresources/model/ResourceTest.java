...
public final class ResourceTest {
  ...
  @Test
  public void testGetAsFloat() throws Exception {
  ...
  @Test
  public void testGetAsIntegerArray() throws Exception {
    ...
    assertEquals(new Resource(new Resource[]{RESOURCE_INTEGER, RESOURCE_FLOAT}).getAsIntegerArray().length, 2);
    assertEquals(new Resource(new Resource[]{RESOURCE_INTEGER, RESOURCE_FLOAT}).getAsIntegerArray()[0], 1);
    assertEquals(new Resource(new Resource[]{RESOURCE_INTEGER, RESOURCE_FLOAT}).getAsIntegerArray()[1], 2);
  }
  ...
  public void testGetAsStringArray() throws Exception {
    ...
    assertEquals(new Resource(new Resource[]{RESOURCE_INTEGER, RESOURCE_FLOAT}).getAsStringArray().length, 2);
    assertEquals(new Resource(new Resource[]{RESOURCE_INTEGER, RESOURCE_FLOAT}).getAsStringArray()[0], "1");
    assertEquals(new Resource(new Resource[]{RESOURCE_INTEGER, RESOURCE_FLOAT}).getAsStringArray()[1], "2.0");
    assertEquals(new Resource((Resource[]) null).getAsStringArray().length, 0);
  }

  @SuppressWarnings("ConstantConditions")
  @Test
  public void testGetAsNumber() throws Exception {
  ...
  public void testGetAsArray() throws Exception {
    ...
    assertEquals(new Resource(new Resource[]{RESOURCE_INTEGER, RESOURCE_FLOAT}).getAsArray().length, 2);
  }

  @Test
  public void testGetAsNonPrimitiveBoolean() throws Exception {
